...
VALUES
    ('TEST001', 'warning', 'modal', 'สินค้าใกล้หมดอายุ', 'สินค้านี้จะหมดอายุภายใน 7 วัน กรุณาตรวจสอบ', 1, 5, NULL, 'system'),
    ('TEST002', 'error', 'modal', 'สินค้าหมดอายุแล้ว', 'สินค้านี้หมดอายุแล้ว ห้ามจัดส่ง!', 1, 5, NULL, 'system'),
    ('TEST003', 'warning', 'toast', 'แจ้งเตือนทั่วไป', 'สินค้านี้ต้องเก็บในอุณหภูมิต่ำ', 1, 5, NULL, 'system');
