...
CREATE TABLE notification_data (
    ...
    note_fill NVARCHAR(1000) NULL,      -- ข้อความที่จะเติมลงใน notes อัตโนมัติเมื่อสแกนเจอ notification นี้
    is_enabled BIT DEFAULT 1,
    job_id INT NULL DEFAULT 5,          -- งานหลัก (อ้างอิง job_types.id) ถ้า NULL = ใช้ได้ทุกงาน (default = 5)
...
INSERT INTO notification_data (barcode, event_type, popup_type, title, message, note_fill, is_enabled, job_id, sub_job_id, created_by)
VALUES
    ('TEST001', 'warning', 'modal', 'สินค้าใกล้หมดอายุ', 'สินค้านี้จะหมดอายุภายใน 7 วัน กรุณาตรวจสอบ', 'ตรวจสอบวันหมดอายุแล้ว,ใกล้หมดอายุ', 1, 5, NULL, 'system'),
    ('TEST002', 'error', 'modal', 'สินค้าหมดอายุแล้ว', 'สินค้านี้หมดอายุแล้ว ห้ามจัดส่ง!', 'สินค้าหมดอายุ,ห้ามจัดส่ง', 1, 5, NULL, 'system'),
    ('TEST003', 'warning', 'toast', 'แจ้งเตือนทั่วไป', 'สินค้านี้ต้องเก็บในอุณหภูมิต่ำ', 'เก็บในอุณหภูมิต่ำ', 1, 5, NULL, 'system');
